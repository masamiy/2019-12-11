...
venue: "UTS"        # brief name of host site without address (e.g., "Euphoric State University")
...
instructor: ["Arindam Basu", "Masami Yamaguchi"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
